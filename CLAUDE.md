...
- Environment variables: `PORT`, `SQLITE_PATH`, `ORDER_NUMBER_START`, `PRINTER_ENABLED`, `WINDOW_PRINTER_HOST`, `WINDOW_PRINTER_PORT`, `KITCHEN_PRINTER_HOST`, `KITCHEN_PRINTER_PORT`, `TLS_CERT`, `TLS_KEY`, `HTTP_PORT`, `SYSTEM_ADMIN_PIN`, `LEADER_PIN`.
